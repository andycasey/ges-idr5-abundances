...
CREATE TABLE homogenised_abundances(
    ...
    ion integer not null,
    abundance real,
    e_pos_abundance real,
    e_neg_abundance real,
    n_nodes int,
    n_measurements int,
    n_lines int,
    n_visits int,
    ...
    PRIMARY KEY (cname, element, ion, version)
    );
...
CREATE TABLE node_results(
    ...
    dec real not null,
    snr real not null,
    vel real default 'NaN',
    e_vel real default 'NaN',
    vrot real default 'NaN',
    e_vrot real default 'NaN',
    teff real default 'NaN',
    e_teff real default 'NaN',
    nn_teff integer default 0,
    enn_teff real default 'NaN',
    nne_teff real default 'NaN',
    sys_err_teff real default 'NaN',
    logg real default 'NaN',
    e_logg real default 'NaN',
    nn_logg integer default 0,
    enn_logg real default 'NaN',
    nne_logg real default 'NaN',
    sys_err_logg real default 'NaN',
    lim_logg integer default 0,
    feh real default 'NaN',
    e_feh real default 'NaN',
    nn_feh integer default 0,
    enn_feh real default 'NaN',
    nne_feh real default 'NaN',
    sys_err_feh real default 'NaN',
    xi real default 'NaN',
    e_xi real default 'NaN',
    nn_xi integer default 0,
    enn_xi real default 'NaN',
    nne_xi real default 'NaN',
    mh real default 'NaN',
    e_mh real default 'NaN',
    nn_mh integer default 0,
    enn_mh real default 'NaN',
    nne_mh real default 'NaN',
    alpha_fe real default 'NaN',
    e_alpha_fe real default 'NaN',
    nn_alpha_fe integer default 0,
    enn_alpha_fe real default 'NaN',
    nne_alpha_fe real default 'NaN',
    vrad real default 'NaN',
    e_vrad real default 'NaN',
    vsini real default 'NaN',
    e_vsini real default 'NaN',
    lim_vsini integer default 0,
    teff_phot real default 'NaN',
    e_teff_phot real default 'NaN',
    teff_irfm real default 'NaN',
    e_teff_irfm real default 'NaN',
    fbol_irfm real default 'NaN',
    he1 real,
